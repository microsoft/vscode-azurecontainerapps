...
console.log("longRunningLocalTestsEnabled:", longRunningLocalTestsEnabled);
console.log("longRunningRemoteTestsEnabled:", longRunningRemoteTestsEnabled);
console.log("longRunningTestsEnabled:", longRunningTestsEnabled);
