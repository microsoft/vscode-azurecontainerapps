...
import type { CustomTelemetryProps } from "../../telemetry/CustomTelemetryProps";
import type { DeployWorkspaceProjectTelemetryProps } from "../../telemetry/telemetry";
...
export type DeployWorkspaceProjectContext = IManagedEnvironmentContext & ICreateContainerAppContext & CreateAcrContext & Partial<IBuildImageInAzureContext> & ExecuteActivityContext & DeployWorkspaceProjectTelemetryProperties & {
    shouldSaveDeploySettings?: boolean;
};

type DeployWorkspaceProjectTelemetryProperties = CustomTelemetryProps<DeployWorkspaceProjectTelemetryProps>;
