...
export async function deployWorkspaceProjectInternal(
    ...
    wizardContext.commandMetadata.additionalInstructions = `
    ...
    If the Dockerfile and dependencies mismatch, focus on changing the Dockerfile to reflect the project, not the other way around.
    `;
