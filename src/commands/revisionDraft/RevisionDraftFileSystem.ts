...
export class RevisionDraftFileSystem implements FileSystemProvider {
    ...
    writeFile(uri: Uri, contents: Uint8Array): void {
        ...
        // Any new changes to the draft file can cause the states of the children to change (e.g. displaying "Unsaved changes")
        ext.state.notifyChildrenChanged(file.containerApp.id);
    }
