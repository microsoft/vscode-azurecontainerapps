...
export class DockerHubNamespaceInputStep extends AzureWizardPromptStep<ContainerRegistryImageContext> {
    ...
    private getSuggestedNamespace(context: ContainerRegistryImageContext): string {
