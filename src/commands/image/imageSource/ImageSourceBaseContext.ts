...
import { CreateAcrContext } from "./containerRegistry/acr/createAcr/CreateAcrContext";

export interface ImageSourceBaseContext extends CreateAcrContext, IContainerAppContext {
    // ImageSourceListStep
