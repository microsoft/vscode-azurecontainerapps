...
export class EnvironmentVariableUpdateDraftStep<T extends EnvironmentVariableUpdateContext> extends RevisionDraftUpdateBaseStep<T> {
    ...
    public async execute(context: T, progress: Progress<{ message?: string | undefined; increment?: number | undefined }>): Promise<void> {
        progress.report({ message: localize('updatingEnv', 'Updating environment variable (draft)...') });
