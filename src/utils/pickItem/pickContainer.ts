...
export function getPickContainerSteps(containerAppItem: ContainerAppItem, options?: RevisionDraftPickItemOptions): AzureWizardPromptStep<QuickPickWizardContext>[] {
    ...
    promptSteps.push(new ContainerItemSubWizardSteps());
    return promptSteps;
}

export class ContainerItemSubWizardSteps<T extends AzureResourceQuickPickWizardContext> extends AzureWizardPromptStep<T> {
