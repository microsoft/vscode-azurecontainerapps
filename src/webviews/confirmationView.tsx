...
import { Button, createTableColumn, DataGrid, DataGridBody, DataGridCell, DataGridRow, TableCellLayout, type OnSelectionChangeData, type SelectionItemId, type TableColumnDefinition } from '@fluentui/react-components';
...
const columns: TableColumnDefinition<Item>[] = [
    ...
    createTableColumn<Item>({
        columnId: 'value',
        renderCell: (item: Item) => {
            return <TableCellLayout >{item.value}</TableCellLayout >;
        },
    })
]
